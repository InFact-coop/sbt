...
if (typeof _astroash$elm_spa_boiler_plate$Main$main !== 'undefined') {
    _astroash$elm_spa_boiler_plate$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Types.Msg":{"args":[],"tags":{"ToggleAudio":["( Types.Message, Types.Stage )"],"ToggleText":["( Types.Message, Types.Stage )"],"RecordStart":["String"],"RecordStop":["String"],"ToggleVideo":["( Types.Message, Types.Stage )"],"ToggleIcon":["( String, Bool )"],"UrlChange":["Navigation.Location"],"RecieveAudio":["String"],"Increment":[]}},"Types.Message":{"args":[],"tags":{"Text":[],"Video":[],"Audio":[]}},"Types.Stage":{"args":[],"tags":{"Stage0":[],"Stage1":[],"Stage2":[]}}},"aliases":{"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Types.Msg"},"versions":{"elm":"0.18.0"}});
}
