...
var _astroash$elm_spa_boiler_plate$Types$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {route: a, userInput: b, reasonForVisiting: c, messageType: d, audioMessage: e, messageLength: f, paused: g};
	});
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$a,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('link brand db w5 h5 bg-white br-100 center f4 tc'),
								_1: {ctor: '[]'}
							}
						},
						{
